...
def test_e2e_sum_reduction_real_llm_and_compile() -> None:
    ...
    result = synthesize(
        "Generate a CUDA kernel for fp32 sum reduction over the last dimension: "
        "out[b] = sum_d x[b, d] for a contiguous row-major 2D tensor x.",
